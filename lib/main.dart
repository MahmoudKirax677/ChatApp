           ...
           // initialBinding: PackageBinding(),
            ...
            builder: (context,widget) {
              ...
              return Directionality(
                textDirection: LocalStorage().getValue("lang") == "ar" ? TextDirection.rtl : TextDirection.ltr,
                child: Stack(
                  children: [
                    widget!,
            ...
            //home: pinCode(),
            home: LocalStorage().getValue("login") == true ? const AppMainPage() : box.read('login') != null ? const AppMainPage() : const Login(),
