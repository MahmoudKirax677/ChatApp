...
class _UsersMainPageState extends State<UsersMainPage> {
  ...
  getMain(context,gender){
    HomeApi(context).mainApi(gender: gender).then((value){
      if(value != false){
          Provider.of<AppProvide>(context,listen: false).mainList = value["data"];
          List indexOfItems = [];
  ...
  Widget build(BuildContext context) {
    var pv = Provider.of<AppProvide>(context);
    return Scaffold(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ToggleSwitch(
                        ...
                        inactiveBgColor: Colors.white,customWidths: const [80,80,85],
      ...
      body: pv.loading ? Container() : pv.mainList.isEmpty && !pv.loading ? RefreshIndicator(
          ...
          child: Padding(
            ...
            child: Center(
              child: Wrap(
                ...
                spacing: 10,
                runSpacing: 10,
                children: List.generate(pv.mainList.length, (index) => GestureDetector(
                  onTap: (){
                    pv.mainList[index]["user_status_id"] == 2 ? null : Navigator.push(
                      context,
                      PageRouteBuilder(
                        pageBuilder: (context, animation1, animation2) {
                          return OtherProfileMainPage(otherProfileData: Provider.of<AppProvide>(context,listen: true).mainList[index],from: 2,);
                        },
                  ...
                  child:
                  ///New Add
                 /// pv.mainList[index]["user_status_id"] != 0 ? Container() :
                  Container(
                      height: 175,
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          ! Provider.of<AppProvide>(context,listen: true).mainList[index]["trusted"] ? Container() : const Positioned(
                            bottom: 10,
                            left: 15,
                            child: SizedBox(
                              child: CircleAvatar(
                          ...
                          Column(
                            children: [
                              const SizedBox(height: 10,),
                              SizedBox(
                                child: pv.mainList[index]["images"] == null ? CircleAvatar(
                                  radius: 40.0,
                                  ...
                                  child: CircleAvatar(
                                    ...
                                    child: Align(
                                      ...
                                      child: UserState(id: pv.mainList[index]["id"],size: 15.0,radius: 10.0),
                                    ),
                                  ),
                                )
                                    :
                                CircleAvatar(
                                  ...
                                  child: CircleAvatar(
                                    radius: 38.0,
                                    backgroundColor: const Color(0xffc52278),
                                    backgroundImage: NetworkImage(pv.mainList[index]["images"]),
                                    child: Align(
                                      alignment: Alignment.bottomRight,
                                      child: UserState(id: pv.mainList[index]["id"],size: 15.0,radius: 10.0),
                                    ),
                              ...
                              const SizedBox(height: 10,),
                              Text(pv.mainList[index]["userName"].toString().substring(0,pv.mainList[index]["userName"].toString().length > 20 ? 20 : pv.mainList[index]["userName"].toString().length),textAlign: TextAlign.center, style: const TextStyle(color: Color(0xffc52278), fontWeight: FontWeight.bold, fontSize: 15.0,),),
                              pv.mainList[index]["age"] == null || pv.mainList[index]["age"] == "0" ? Container() : Text("العمر : ${pv.mainList[index]["age"]}", style: const TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 12.0,),),
                              Text("${pv.mainList[index]["countryName"]}", style: const TextStyle(color: Colors.black54, fontWeight: FontWeight.bold, fontSize: 12.0,),),
                              const SizedBox(height: 10,),
                            ],
                          ),
                        ],
